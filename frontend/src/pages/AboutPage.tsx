...
const AboutPage = () => {
  return (
    <Layout
      title="About Us | RankReadyTools"
      description="Learn about RankReadyTools - your trusted resource for free SEO tools and website optimization solutions."
      keywords="about rankreadytools, seo tools, free seo tools, website optimization"
    >
      <div className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-4xl font-bold mb-6">About RankReadyTools</h1>
            
            <div className="prose prose-lg max-w-none">
              <p>
                RankReadyTools is a comprehensive platform providing free SEO tools to help website owners, 
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">Why Choose RankReadyTools?</h2>
              ...
              <p>
                RankReadyTools is developed and maintained by a team of SEO experts, web developers, and 
